...
export function AccessPage() {
    ...
    // Efeito Colateral Correto (Sincroniza os dados da API com o estado dos checkboxes)
    useEffect(() => {
        if (grants !== undefined) {
            setSelected(grants);
        }
            ...
            <div className="rise rise-2" style={{ display: "grid", gap: 14 }}>
                <select
                    ...
                    onChange={(e) => {
                        ...
                        // UX: Limpa imediatamente os checkboxes para não mostrar acessos antigos enquanto carrega
                        setSelected([]);
                    }}
                >
                ...
                {targetId !== "" && (
                    <div className="ticket" style={{ padding: 18, display: "grid", gap: 10 }}>
                        ...
                        {saved && <p style={{ color: "var(--ok)", margin: 0 }} data-testid="success-message">Acessos salvos.</p>}
