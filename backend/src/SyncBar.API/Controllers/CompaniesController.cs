    ...
    IUnitOfWork unitOfWork) : ApiController(mediator)
{
    ...
    private async Task<IActionResult> ExecuteWithLogAsync(string methodName, Func<Task<IActionResult>> action)
    {
        ...
        var log = new LogTracker(0)
        {
            ...
            ClassName = nameof(CompaniesController), // Substitua pelo nome da Controller correspondente
        ...
        try
        {
            ...
            // Consideramos sucesso apenas Ok, NoContent e CreatedAtAction
            ...
            else
            {
                ...
                {
                    // Se o objeto for um ProblemDetails ou similar, tentamos extrair a propriedade 'detail' ou 'title'
        ...
        finally
        {
            ...
            try
            {
                // Salva o log garantindo independência de transações corrompidas por erros anteriores
