...
internal sealed class GetSalesReportQueryHandler(
    ...
    : BaseQueryHandler<GetSalesReportQuery, SalesReportResponse>(logRepository, unitOfWork)
{
    public override async Task<Result<SalesReportResponse>> Handle(GetSalesReportQuery request, CancellationToken cancellationToken)
    {
        return await ExecuteWithLogAsync(
            nameof(GetSalesReportQueryHandler),
            nameof(Handle),
