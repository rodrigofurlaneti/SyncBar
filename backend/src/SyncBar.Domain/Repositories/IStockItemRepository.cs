...
public interface IStockItemRepository
{
    ...
    Task<StockItem?> GetByIdForUpdateAsync(long id, CancellationToken cancellationToken = default);
    Task<IReadOnlyCollection<StockItem>> GetByBranchAsync(long branchId, CancellationToken cancellationToken = default);
