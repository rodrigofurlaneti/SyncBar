...
// Additive migration for the existing SQL-managed schema.
[DbContext(typeof(AppDbContext))]
[Migration("202609090002_AddProductExtrasAndBoosts")]
public sealed class AddProductExtrasAndBoosts : Migration
{
...
DROP TABLE `productboost`;
DROP TABLE `productoptionalextra`;
ALTER TABLE `product` DROP COLUMN `HasOptionalExtras`, DROP COLUMN `HasBoosts`;
""");
}
